...
public class ToggleButtonBlue : MonoBehaviour
{
    ...
    void Toggle()
    {
        ...
        StartCoroutine(_camera.CinematicaInterruptorSimple(_player, _togglePlatform));
        _togglePlatform.SendMessage("InvertActivatedDesactivated");

        if (isTimed) StartCoroutine(Timed());
    }
